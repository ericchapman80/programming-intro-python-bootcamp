...
| --- | --- | --- | --- | --- |
| 00 | Tools, Terminal, local vs remote | README or reflection | `brew --version`, `python3 --version`, `git --version`, `code --version` | Explain each tool |
| 01 | `.py`, `print()`, syntax | `app/app.py` | `python3 app.py` | Change message live |
